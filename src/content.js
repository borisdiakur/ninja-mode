function addNinjaMode() {
  ...
  style.innerText = `
    * {
    ...
    :is(img:not([src$='.svg']), video, image, [style*='background-image: url']:not([style*='data:image/gif'], [style*='data:image/svg']), [style*='background: url']:not([style*='data:image/gif'], [style*='data:image/svg'])) {
